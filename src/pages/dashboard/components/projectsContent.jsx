      ...
      {isLoading ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {projects.map((project) => (
            <div
              key={project.id}
              className="bg-[#282A3A] p-6 rounded-lg shadow-md flex flex-col transform hover:scale-105 transition duration-300"
            >
              <h2 className="text-2xl font-bold mb-2 text-[#C69749]">
                {project.projectName}
              </h2>
              ...
              <div className="mb-2 flex flex-wrap gap-2">
                {project.skills.split(", ").map((skill) => (
                  <span
                    key={skill}
                    className="bg-[#C69749] text-[#000000] py-1 px-3 rounded-full"
                  >
                    {skill}
                  </span>
                ))}
              ...
              <a
                href={project.link}
                className="text-[#C69749] hover:underline mb-4"
                target="_blank"
