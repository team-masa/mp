    ...
    <div className="flex h-screen">
      ...
      <div className="flex-1 flex items-center justify-center bg-[#3F3D56]">
        <div className="w-full max-w-md p-8 space-y-8">
          <h2 className="text-5xl font-bold text-[#C69749] dark:text-[#C69749]">
            Welcome
          </h2>
          <p className="text-base text-[#C69749] dark:text-[#C69749]">
          ...
          <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
            <div className="relative">
              ...
              <input
                ...
                } rounded-md focus:ring-[#F50081] focus:border-[#F50081]`}
              />
              {errors.email && (
            ...
            <div className="flex items-center justify-between">
              <a href="#" className="text-sm text-[#C69749] hover:underline">
            ...
            <p className="text-sm text-center text-white/60 dark:text-gray-600">
              ...
              <a
                href="#"
                className="text-[#C69749] hover:underline"
            ...
            <div className="flex justify-center space-x-4 mt-4">
              <a
                href="#"
                className="text-white/60 dark:text-gray-600 hover:text-[#]"
              >
                <FaFacebookF />
              </a>
              <a
