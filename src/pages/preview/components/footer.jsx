  ...
  return (
    <footer className='bg-slate-800 text-white lg:px-48 px-4 py-20'>
      <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-4'>
        ...
        <div className='mb-4 md:mb-0'>
          <h2 className='text-[22px] font-semibold text-[#735F32] py-2 uppercase'>CONTACT</h2>
          <p className='text-[16px] mb-4'>Email: acquahmabel60@gmail.com</p>
          <p className='text-[16px] mb-4'>Phone: +233 559 618 020</p>
        </div>
        <div>
        <h2 className='text-[22px] font-semibold text-[#735F32] py-2 uppercase'>FOLLOW ME</h2>
<div className='flex space-x-4 text-[26px]'>
  <a className='text-white hover:text-fuchsia-800 transition-all duration-150 ease-in-out' href=""><FaGithub/></a>
  <a className='text-white hover:text-fuchsia-800 transition-all duration-150 ease-in-out' href=""><FaLinkedinIn/></a>
  <a className='text-white hover:text-fuchsia-800 transition-all duration-150 ease-in-out' href=""><FaTwitter/></a>
