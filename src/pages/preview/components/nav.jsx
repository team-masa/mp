...
<span className='text-3xl font-bold'>Belkins</span>
        </div>
...
<ul className='flex gap-8 mr-16 text-[18px]'>
        <Link spy={true} smooth={true} to="Home">
          <li className='hover:text-[#f50057] transition border-b-2 border-slate-900 hover:border-fuchsia-600 cursor-pointer'>
            Home
          </li>
